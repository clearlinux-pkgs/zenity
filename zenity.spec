...
Source0  : https://download.gnome.org/sources/zenity/3.42/zenity-3.42.0.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : LGPL-2.1
Requires: zenity-bin = %{version}-%{release}
Requires: zenity-data = %{version}-%{release}
Requires: zenity-license = %{version}-%{release}
Requires: zenity-locales = %{version}-%{release}
Requires: zenity-man = %{version}-%{release}
...
%package bin
Summary: bin components for the zenity package.
Group: Binaries
Requires: zenity-data = %{version}-%{release}
Requires: zenity-license = %{version}-%{release}

%description bin
bin components for the zenity package.


%package data
Summary: data components for the zenity package.
Group: Data

%description data
data components for the zenity package.


%package doc
Summary: doc components for the zenity package.
Group: Documentation
Requires: zenity-man = %{version}-%{release}

%description doc
doc components for the zenity package.


%package license
Summary: license components for the zenity package.
Group: Default

%description license
license components for the zenity package.


%package locales
Summary: locales components for the zenity package.
Group: Default

%description locales
locales components for the zenity package.


%package man
Summary: man components for the zenity package.
Group: Default

%description man
man components for the zenity package.


%prep
%setup -q -n zenity-3.42.0
cd %{_builddir}/zenity-3.42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649269283
...
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dlibnotify=true \
-Dwebkitgtk=true  builddir
ninja -v -C builddir

%install
mkdir -p %{buildroot}/usr/share/package-licenses/zenity
cp %{_builddir}/zenity-3.42.0/COPYING %{buildroot}/usr/share/package-licenses/zenity/01a6b4bf79aca9b556822601186afab86e8c4fbf
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/zenity/01a6b4bf79aca9b556822601186afab86e8c4fbf

%files man
%defattr(0644,root,root,0755)
/usr/share/man/man1/zenity.1
