...
Source0  : https://download.gnome.org/sources/zenity/4.0/zenity-4.0.2.tar.xz
...
%prep
%setup -q -n zenity-4.0.2
cd %{_builddir}/zenity-4.0.2
pushd ..
cp -a zenity-4.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721085240
