...
Source0  : https://download.gnome.org/sources/zenity/4.0/zenity-4.0.3.tar.xz
...
%prep
%setup -q -n zenity-4.0.3
cd %{_builddir}/zenity-4.0.3
pushd ..
cp -a zenity-4.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729873293
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dwebkitgtk=true \
-Dmanpage=false  builddir
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dwebkitgtk=true \
-Dmanpage=false  builddiravx2
