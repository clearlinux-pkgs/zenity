...
Source0  : https://download.gnome.org/sources/zenity/3.30/zenity-3.30.0.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : LGPL-2.0
Requires: zenity-bin
Requires: zenity-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1538841001
...
export SOURCE_DATE_EPOCH=1538841001
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/zenity
cp COPYING %{buildroot}/usr/share/doc/zenity/COPYING
%make_install
%find_lang zenity
